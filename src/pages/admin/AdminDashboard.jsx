    ...
    <AdminLayout title="Ringkasan Dashboard">
      <div className="space-y-8 animate-fade-in">
        ...
        <div className="bg-gradient-to-r from-[#5D3A29] to-[#8B5742] rounded-[2.5rem] p-6 sm:p-8 text-white relative overflow-hidden shadow-[0_16px_40px_rgba(93,58,41,0.15)]">
          ...
          <div className="relative z-10 max-w-xl">
            ...
            <p className="text-xs sm:text-sm text-stone-200 leading-relaxed">
              Setiap perubahan produk, stok, atau status pesanan yang Anda lakukan di dashboard ini akan langsung terhubung secara real-time ke website pelanggan.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Link
            to="/admin/orders"
            className="inline-flex items-center gap-2 bg-white/80 hover:bg-white text-[#5D3A29] px-5 py-3 rounded-2xl text-xs font-bold uppercase tracking-wider border border-white/90 shadow-2xs transition-all active:scale-95"
          >
        ...
        {/* 4. RECENT ORDERS & LOW STOCK ALERTS ROW */}
